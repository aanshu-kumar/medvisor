...
const ChatlogAI = ({ message }) => {
  return (
    <>
      <div className=" chatlog `${message.user === Medvisor  ? flex text-gray-50  :  }`">
        <div className="chat-message  `${message.user === Medvisor  ? mt-14 bg-[#4f6f52]  border-zinc-600 rounded-xl : mt-14 border-zinc-600  rounded-xl }`">
